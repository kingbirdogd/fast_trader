...
dummy::dummy(user& u, const std::string& name):
	algo(u, name)
{

}

void dummy::on_omdc_book(const Tradable& tradable)
{
...
void dummy::on_omdc_trade(const Tradable& tradable)
{
...
void dummy::on_omdd_book(const Tradable& )
{

}

void dummy::on_omdd_trade(const Tradable& )
{

}


void dummy::handler_order(const dbp::top::enhance_order& )
{
	/*
...
void dummy::Log(string msg){
	logger->Log(string(DateUtil::getCurrentTime()) + " " + msg);
}

void dummy::handle_command(algo_msg_base& msg)
{
	msg.on_command();
}

algo_msg_base* dummy::json_to_msg(json& json)
{
...
std::string dummy::get_lib_name()
{
	return "dummy";
}

void dummy::on_tcp_book(const Tradable&)
{
}

void dummy::on_tcp_trade(const Tradable&)
{
}

rapid_ring::spmc_ring_buffer_object_pool<dummy::algo_err_msg, 8192> dummy::algo_err_msg_pool;
