#ifndef STATIC_ALGOS_INC_DUMMY_HPP_
#define STATIC_ALGOS_INC_DUMMY_HPP_
#include <msg.hpp>
#include <json.hpp>
#include <string>
#include <vector>
...
public:
	dummy() = delete;
	dummy(user& u, const std::string& name);
	dummy(const algo&) = delete;
	dummy(algo&&) = delete;
	dummy& operator= (const algo&) = delete;
	dummy& operator= (algo&&) = delete;
...
#endif /* STATIC_ALGOS_INC_DUMMY_HPP_ */
