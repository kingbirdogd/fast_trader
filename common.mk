...
ifeq ($(CONFIG),debug)
MACROS+=-DTARGET_NAME=$(TARGET_NAME) -DPYINIT=PyInit_$(TARGET_NAME) -DCONFIG_DEBUG $(LATENCY_FLAG) $(FULLTICK_FLAG)
else
MACROS+=-DTARGET_NAME=$(TARGET_NAME) -DPYINIT=PyInit_$(TARGET_NAME) $(LATENCY_FLAG) $(FULLTICK_FLAG)
endif
