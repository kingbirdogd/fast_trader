...
ifeq ($(CONFIG),debug)
MACROS+=-DTARGET_NAME=$(TARGET_NAME) -DPYINIT=PyInit_$(TARGET_NAME) -DCONFIG_DEBUG $(LATENCY_FLAG) $(FULLTICK_FLAG) $(SF_FLAG) $(DF_FLAG) $(FULLBOOK_FLAG) $(CAPTURE_FLAG)
else
ifeq ($(CONFIG),debug_log)
MACROS+=-DTARGET_NAME=$(TARGET_NAME) -DPYINIT=PyInit_$(TARGET_NAME) -DCONFIG_DEBUG $(LATENCY_FLAG) $(FULLTICK_FLAG) $(SF_FLAG) $(DF_FLAG) $(FULLBOOK_FLAG) $(CAPTURE_FLAG)
else
MACROS+=-DTARGET_NAME=$(TARGET_NAME) -DPYINIT=PyInit_$(TARGET_NAME) $(LATENCY_FLAG) $(FULLTICK_FLAG) $(SF_FLAG) $(DF_FLAG) $(FULLBOOK_FLAG) $(CAPTURE_FLAG)
endif
endif
