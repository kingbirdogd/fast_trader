...
public:
	...
	void set_pair(pair&& p, bool no_change);
	void delete_pair(const std::string& ref);
	void force_buy(unsigned long long quantity, const std::string& ref);
	void force_sell(unsigned long long quantity, const std::string& ref);
