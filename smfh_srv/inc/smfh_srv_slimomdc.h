...
#ifndef NOT_MEASURE
inline static void handleSlimOmdc(dbp::omd::COmdMsgHeader* _pMsg, unsigned long long _uPkgTm)
#else
inline static void handleSlimOmdc(dbp::omd::COmdMsgHeader* _pMsg, unsigned long long)
#endif
{
