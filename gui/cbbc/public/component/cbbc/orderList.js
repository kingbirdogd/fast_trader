class OrderList extends React.Component {
  ...
  handleClick() {
    ...
    var data = formatTableData('.table-order')
    ...
    return(
      <div className='row'>
        <div className="col-12">
          <div className="row">
            <div className="col-6"> <h6> {text.transaction} </h6> </div>
            <div className="col-6"> <button className="btn btn-sm btn-secondary float-right" onClick={this.handleClick}>{text.download} {text.transaction}</button>  </div>
          </div>
