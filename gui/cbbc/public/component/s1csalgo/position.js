class Position extends React.Component {
  ...
  handleWs() {
    ...
    var command = {cmd: 'winsell', algo_name: algoName, id: userId, ref: 'uid_'+userId.toString(), code: code, ucode: ucode, action: 'set'}
    sendWebsocket(JSON.stringify(command))
  }
  ...
  handleWls() {
    ...
    var command = {cmd: 'winlvlsell', algo_name: algoName, id: userId, ref: 'uid_'+userId.toString(), code: code, ucode: ucode, action: 'set'}
    sendWebsocket(JSON.stringify(command))
  }
